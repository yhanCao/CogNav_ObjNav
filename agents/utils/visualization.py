...
def init_vis_image(goal_name, legend):
    ...
    vis_image = cv2.putText(vis_image, text, (textX, textY),
                            ...
                            cv2.LINE_AA)
    text = "Segmentation and prediction"
    textsize = cv2.getTextSize(text, font, fontScale, thickness)[0]
    ...
    vis_image[49, 670:1310] = color
    vis_image[49, 1325:1805] = color
    vis_image[50:530, 14] = color
    vis_image[50:530, 655] = color
    vis_image[50:530, 669] = color
    vis_image[50:530, 1310] = color
    vis_image[50:530, 1324] = color
    vis_image[50:530, 1805] = color
    vis_image[530, 15:655] = color
    vis_image[530, 670:1310] = color
    vis_image[530, 1325:1805] = color
    # draw legend
