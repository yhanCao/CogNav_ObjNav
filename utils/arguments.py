...
def get_args():
    ...
    parser.add_argument('--skip_times', type=int, default=0)
    ...
    parser.add_argument('--path_object_norm_inv_perplexity', type=str, default='DATA/HM3D/object_norm_inv_perplexity.npy')
